...
- **Scripting Features**:
    ...
    - **GUI Builder**: Task-based script generation with dynamic parameter forms, supporting **exactly 1000 automation tasks across 48 platforms** (909 premium tasks across 48 enterprise platforms + 91 free tasks across 7 Windows management platforms). Version 3.0 expansion added 91 new premium tasks distributed across Microsoft Identity (Hyper-V +8, Power Platform +8, Windows Server +6, AD +5), Office 365 ecosystems (Exchange Online +10, Exchange Server +8, Office 365 +5), Azure (Azure Resources +7), AWS +8, GCP +5, and virtualization/infrastructure platforms (Docker/K8s +5, VMware +6, Citrix +5, Veeam +5, Nutanix +5). All 909 premium tasks include `isPremium: true` runtime flags for subscription enforcement.
